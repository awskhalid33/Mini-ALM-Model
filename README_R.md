...
An R Shiny application for analyzing pension fund solvency under different bond portfolio allocations and interest rate scenarios. This tool helps determine optimal investment strategies to maintain solvency (assets ≥ liabilities) across various market conditions.
...
- **Analyzes interest rate sensitivity**: Tests performance across 1%-10% interest rates
